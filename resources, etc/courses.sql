...
term_offered VARCHAR(40),
mid_proc_exam VARCHAR(50),
fin_proc_exam VARCHAR(50),
hpm_req VARCHAR(50),
int_req VARCHAR(50),
PRIMARY KEY (id) 
);
...
#VALUES NEED MORE INFO ("PHW202", , "Ethnic and Cultural Diversity in Health Status and Behavior", " Examining the ethnic and cultural differences #in health status among historically marginalized communities in the U.S., we will draw readings from epidemiological, anthropological, and demographic research, as well as relevant social theory to understand the influence of ethnicity, culture, race, and social determinants on concepts of health, illness, and disease patterns.", , , , , ),

#VALUES NEED MORE INFO ("PHW209", , "Comparative Health Systems", "Using the Murray-Frenk health systems framework, you will engage in a real-world, #practical analysis of health systems, along with engaging in current debates about health systems, health financing, and UHC in the international community. Assess health system performance based on quality, cost, and access metrics.", "Spring-2 2019", , , , , ), 

#VALUES NEED MORE INFO ("PHW253", , "Outbreak Investigations",  "You will learn why and how clusters of illnesses/epidemics are investigated. #Methods and approaches required for such investigations will be discussed in detail, with a specific focus on basic concepts, developing case definitions, laboratories, surveillance, epidemiology of outbreak data, hypotheses, and communication of results, all in relation to outbreak investigations. ", , , , , ),

#VALUES NEED MORE INFO ("PHW236", , "Regulatory Science", "In Regulatory Science, Drug Development, and Public Health, you will be armed with the knowledge to address the most important health practice and product regulation issues in the U.S. and abroad from the perspective of the current regulatory standards, their standards for evidence, and the role of innovation in regulatory science., , , , , "
